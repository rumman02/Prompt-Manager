...
/* macOS segmented control: rounded-10, muted background, subtle shadow. */
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-8 items-center justify-center rounded-[10px] bg-muted p-1 text-muted-foreground shadow-macos-inset",
      className
    )}
    {...props}
  />
