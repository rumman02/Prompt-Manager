...
export function PromptListItem({ prompt, onSelect, onEdit, onDelete, onToggleFavorite }: PromptListItemProps) {
  ...
  return (
    <div
      className="group grid grid-cols-[1fr_auto_8rem_10rem_6rem] gap-4 items-center px-4 py-3 hover:bg-muted/50 cursor-pointer transition-colors"
    ...
    >
      ...
      <div className="w-24 flex items-center justify-start gap-1 shrink-0">
        {onToggleFavorite && (
          <button
